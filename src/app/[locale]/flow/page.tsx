...
export default async function FlowPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  ...
  const steps = [
    { num: t("step1Number"), title: t("step1Title"), desc: t("step1Description"), note: t("step1Note") },
    { num: t("step2Number"), title: t("step2Title"), desc: t("step2Description"), note: t("step2Note") },
    { num: t("step3Number"), title: t("step3Title"), desc: t("step3Description"), note: t("step3Note") },
    { num: t("step4Number"), title: t("step4Title"), desc: t("step4Description"), note: t("step4Note") },
    { num: t("step5Number"), title: t("step5Title"), desc: t("step5Description"), note: t("step5Note") },
    { num: t("step6Number"), title: t("step6Title"), desc: t("step6Description"), note: t("step6Note") },
  ];
