...
export const caregivers: Caregiver[] = [
  {
    slug: "tanaka-hanako",
    name: "田中 花子",
    photo: "/images/caregivers/caregiver-tanaka-hanako.png",
    gender: "female",
    age_range: "30代",
  ...
  },
  {
    slug: "yamamoto-kenji",
    name: "山本 健二",
    photo: "/images/caregivers/caregiver-yamamoto-kenji.png",
    gender: "male",
    age_range: "40代",
  ...
  },
  {
    slug: "nakamura-yuki",
    name: "中村 由紀",
    photo: "/images/caregivers/caregiver-nakamura-yuki.png",
    gender: "female",
    age_range: "20代",
  ...
  },
  {
    slug: "sato-hiroshi",
    name: "佐藤 大",
    photo: "/images/caregivers/caregiver-sato-hiroshi.png",
    gender: "male",
    age_range: "50代",
  ...
  },
  {
    slug: "kawano-miho",
    name: "川野 美穂",
    photo: "/images/caregivers/caregiver-kawano-miho.png",
    gender: "female",
    age_range: "30代",
    ...
    detail_message:
      "手話通訳士として10年、聴覚障がいのある方のさまざまな場面でのコミュニケーション支援を行ってきました。旅行中は観光地でのガイド通訳・ホテルでのやりとり・交通機関での案内など、あらゆる場面でスムーズにコミュニケーションが取れるよう支援します。「旅先での意思疎通が心配」という方は、ぜひご相談ください。",
    hobbies: "手話劇、旅行",
    available: true,
  },
  {
    slug: "ishida-tomoko",
    name: "石田 友子",
    photo: "/images/caregivers/caregiver-ishida-tomoko.png",
    gender: "female",
    age_range: "40代",
...
export function filterCaregivers(params: {
  ...
  return caregivers.filter((c) => {
    ...
    if (params.region && !c.regions.includes(params.region as Region))
      return false;
    if (params.supportType && !c.support_types.includes(params.supportType))
      return false;
